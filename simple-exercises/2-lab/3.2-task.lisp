...
; ==== additional functions for comparing strings by length ====
(defun length>(str1 str2)(cond ((> (length str1) (length str2)) t)
							   (t nil)
							   ))
(defun length<(str1 str2)(cond ((< (length str1) (length str2)) t)
							   (t nil)
...
(defun siftDown(lst i n)(cond ((>= (* i 2) n) lst)
							  ((= (+ 1 (* 2 i)) n) (cond ((length> (nth i lst) (nth (+ 1 (* 2 i)) lst))
														  (swap lst i (+ 1 (* 2 i))))
														 (t lst)))
							  ((and (= (+ 1 (* 2 i)) n)
								    (length> (nth i lst) (nth (+ 1 (* 2 i)) lst))
									) (swap lst i (+ 1 (* 2 i))))
							  ((and (length>= (nth i lst) (nth (+ 1 (* 2 i)) lst))
									(length<= (nth (+ 1 (* 2 i)) lst) (nth (+ 2 (* 2 i)) lst))
									) (siftDown (swap lst i (+ 1 (* 2 i))) (+ 1 (* 2 i)) n))
							  ((and (length>= (nth i lst) (nth (+ 2 (* 2 i)) lst))
									(length<= (nth (+ 2 (* 2 i)) lst) (nth (+ 1 (* 2 i)) lst))
